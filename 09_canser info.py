...
#cansr info
info1=browser.find_element_by_xpath("//a[@id='steps-uid-0-t-2']")
time.sleep(3)

#cans/info(1/4)
infor =browser.find_element_by_xpath("//a[@id='steps-uid-0-t-2']")
time.sleep(2)


#q1
Q1=browser.find_element_by_xpath("//select[@id='SubType']")
Q1.send_keys("Colon")
time.sleep(3)


#q2
q2=browser.find_element_by_xpath("//select[@id='diagnosedMonth']")
q2.send_keys('August')
time.sleep(3)

#year
year=browser.find_element_by_xpath("//select[@id='diagnosedYear']")
year.send_keys('1992')
time.sleep(4)

#Q3
q3 = browser.find_element_by_xpath("//input[@id='no_cancer_stage']")
q3.click()
time.sleep(3)

#q4
q4=browser.find_element_by_xpath("//input[@id='no_cancer_spread']")
q4.click()
time.sleep(3)
